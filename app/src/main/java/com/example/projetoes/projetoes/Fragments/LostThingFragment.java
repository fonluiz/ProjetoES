 ...
 * {@link com.example.projetoes.projetoes.Fragments.OnLostThingSelectedListener} interface
 * to handle interaction events.
 * Use the {@link LostThingFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LostThingFragment extends Fragment implements OnLostThingSelectedListener{
    ...
    private OnLostThingSelectedListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        try {
            mListener = (OnLostThingSelectedListener) context;
        } catch (ClassCastException e) {
            throw new ClassCastException(context.toString()
                    + " must implement OnHeadlineSelectedListener");
        }
//        if (context instanceof OnLostThingSelectedListener {
//            mListener = (OnLostThingSelectedListener) context;
//        } else {
